/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/feedback/wrangler.jsonc cloudflare/feedback/worker-configuration.d.ts` (hash: 8b331258b6b4d1a3e944dc2e87dd7592)
